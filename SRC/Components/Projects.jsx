...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 bg-black"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-slide-up bg-black/50 p-8 rounded-2xl shiny-border shiny-border-hover order-1 md:order-2">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold">
              Hi, I'm{' '}
              <span className="gradient-text">Subham A</span>
            </h1>
          ...
          <div className="flex justify-center animate-float">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 shadow-[0_0_50px_rgba(59,130,246,0.6)] border-4 border-blue-500"></div>
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 opacity-20 blur-2xl"></div>
            </div>
          </div>
        </div>
      </div>
